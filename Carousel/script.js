...
function initEventListeners() {
  heroPrev.addEventListener("click", () => nextSlide(-1));
  heroNext.addEventListener("click", () => nextSlide(1));
  heroNav0.addEventListener("click", () => liveSlide(0));
  heroNav1.addEventListener("click", () => liveSlide(1));
  heroNav2.addEventListener("click", () => liveSlide(2));
}
